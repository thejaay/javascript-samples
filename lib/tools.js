...
{
	playlistId = parseInt(document.getElementById('playlistID').value);
...
function addSongToPlaylist() {
    ...
    DZ.api('/playlist/' + playlistId + '/tracks', 'POST',
        {
            //tracks : songListParam,
            songs : "2114406,6461724,6461725,128839677,76947803,414838122",
            //order : songListParam,
            order : "2114406,6461724,6461725,128839677,76947803,414838122",
            access_token: userToken
        },
        function (response) {
        	if(response.error)
